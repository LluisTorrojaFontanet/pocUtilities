...
public class ExerciserJPEG2PDF {

	public static void main(String[] args) throws DocumentException, MalformedURLException, IOException {

		System.out.println("Processant...");
		ExerciserJPEG2PDF jpg2pdf = new ExerciserJPEG2PDF();
		jpg2pdf.doTheJob();
	...
	private void doTheJob() throws DocumentException, MalformedURLException, IOException {
		...
		PdfWriter.getInstance(document, new FileOutputStream("src/main/resources/jpg2pdf.pdf"));
		...
		byte[] imatge01Bytes = Files.readAllBytes(new File("src/main/resources/imatge01.jpg").toPath());
		...
		byte[] imatge02Bytes = Files.readAllBytes(new File("src/main/resources/imatge02.jpg").toPath());
