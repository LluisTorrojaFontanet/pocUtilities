...
public class ExerciserImageRotate extends Application {
	@Override
	public void start(Stage stage) {
		Image image = new Image("http://worldpress.org/images/maps/world_600w.jpg", 350, 0, true, true);
		...
		stack.setStyle(
				"-fx-background-image: url('http://1.bp.blogspot.com/_wV5JMD1OISg/TDYTYxuxR4I/AAAAAAAAvSo/a0zT8nwPV8U/s400/louis-vuitton-nice-beautiful.jpg');");
	...
	public static void main(String[] args) {
		launch(ExerciserImageRotate.class);
	}
}